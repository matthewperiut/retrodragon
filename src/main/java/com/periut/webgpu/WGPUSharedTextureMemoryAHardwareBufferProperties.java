 ...
 * }
 */
public class WGPUSharedTextureMemoryAHardwareBufferProperties {
    ...
    private static final GroupLayout yCbCrInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("yCbCrInfo"));
     ...
     * }
     */
    public static final GroupLayout yCbCrInfo$layout() {
        return yCbCrInfo$LAYOUT;
    }

    private static final long yCbCrInfo$OFFSET = $LAYOUT.byteOffset(groupElement("yCbCrInfo"));
     ...
     * }
     */
    public static final long yCbCrInfo$offset() {
        return yCbCrInfo$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment yCbCrInfo(MemorySegment struct) {
        return struct.asSlice(yCbCrInfo$OFFSET, yCbCrInfo$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void yCbCrInfo(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, yCbCrInfo$OFFSET, yCbCrInfo$LAYOUT.byteSize());
    }
