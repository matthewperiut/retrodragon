 ...
 * }
 */
public class WGPUTextureComponentSwizzleDescriptor {
    ...
    private static final GroupLayout swizzle$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("swizzle"));
     ...
     * }
     */
    public static final GroupLayout swizzle$layout() {
        return swizzle$LAYOUT;
    }

    private static final long swizzle$OFFSET = $LAYOUT.byteOffset(groupElement("swizzle"));
     ...
     * }
     */
    public static final long swizzle$offset() {
     ...
     * }
     */
    public static MemorySegment swizzle(MemorySegment struct) {
        return struct.asSlice(swizzle$OFFSET, swizzle$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void swizzle(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, swizzle$OFFSET, swizzle$LAYOUT.byteSize());
    }
