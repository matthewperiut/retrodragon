...
public class WGPUAdapterInfo {
    ...
    private static final long subgroupMinSize$OFFSET = $LAYOUT.byteOffset(groupElement("subgroupMinSize"));
    ...
    private static final long subgroupMaxSize$OFFSET = $LAYOUT.byteOffset(groupElement("subgroupMaxSize"));
