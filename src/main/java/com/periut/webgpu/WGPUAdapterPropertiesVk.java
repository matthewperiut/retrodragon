 ...
 * }
 */
public class WGPUAdapterPropertiesVk {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        webgpu_h.C_INT.withName("driverVersion"),
    ...
    private static final long driverVersion$OFFSET = $LAYOUT.byteOffset(groupElement("driverVersion"));
